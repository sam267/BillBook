 ...
 */
public class MyCreditListAdapter extends ArrayAdapter {
    private final Context context;

int count=0;
    private  final String[][] data;

    public MyCreditListAdapter(Context context,String[][] data) {
        super(context, R.layout.credit_list_item);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.credit_list_item, parent, false);
